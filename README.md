...
- Editable budget line items, including the ability to change existing descriptions/target amounts and add/remove rows.
...
- The reset button clears only entered budget tracking fields (actual/final/paid/company) and keeps your current budget line items and target values.
